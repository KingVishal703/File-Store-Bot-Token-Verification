...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002285521005"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "5654093580"))
PORT = os.environ.get("PORT", "8080")

#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://bevag22776:LTYSLtfLKt2KCMnD@cluster0.6z90l.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002021693647"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "5654093580").split()):
        ADMINS.append(int(x))
except ValueError:
